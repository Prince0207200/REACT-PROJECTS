...
export const devTips = [
  ...
  "Code reviews are not criticism; they’re free learning!",
  "Use async/await instead of callback hell.",
  "Keyboard shortcuts save hours – learn them!",
  "Dark mode isn't just for aesthetics; it's easier on the eyes.",
  "Automate repetitive tasks with scripts.",
  "Understand Big O notation – efficiency matters!",
  "Read official documentation before Stack Overflow.",
  "A clean UI starts with a clean codebase.",
  "Tech changes fast – keep learning!",
  "Use a linter to catch issues before they become problems.",
  "Design before you code – planning saves time!",
  "Back up your work – because accidents happen.",
  "Stay hydrated – debugging dehydration is harder than debugging code. 💧",
  "Google is your best friend, but knowing what to search for is a skill.",
  "Take breaks – a fresh mind solves bugs faster!",
